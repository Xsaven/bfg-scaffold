    ...
    <v-container>
        <v-simple-table v-if="relations.length">
            <template v-slot:default>
                ...
                <m-draggable v-model="relations" tag="tbody" handle=".handle">
                    <tr v-for="(item, i) in relations" :key="`${model.id}_relation_${i}_${item.id}`">
                        ...
                        <td>
                            <v-autocomplete
                                v-model="item.type"
                                :items="$store.state.global.relation_types"
                                @change="changed"
                            ></v-autocomplete>
                        </td>
                        <td>
                        ...
                        <td>
                            <c-dialog-relation-edit :item.sync="item" :key="`${model.id}_edit_relation_${i}_${item.id}`" :changed="changed" />
